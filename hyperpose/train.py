...
if __name__ == '__main__':
    ...
    config.pretrain.batch_size=8
    config.eval.batch_size=1
    config.train.batch_size=8
    config.model.hin = 192
    config.model.win = 256
    config.model.hout = 24 # 192/8
    config.model.wout = 32 # 256/8
    config.train.save_interval = 10000
    config.train.vis_interval = 5000
    config.train.n_step = 250000

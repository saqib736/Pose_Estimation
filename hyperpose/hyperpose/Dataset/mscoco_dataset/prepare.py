...
def prepare_dataset(data_path="./data",version="2017",task="person"):
        ...
        if version == "2014":
            ...
            if os.path.exists(os.path.join(path,"annotations","person_keypoints_test2017.json")) is False:
        ...
        if version == "2014":
            ...
            test_annotations_file_path = os.path.join(path,"annotations","person_keypoints_test2017.json")
